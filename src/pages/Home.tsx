  ...
  return (
    <motion.div variants={fadeInUp} className="flex flex-col gap-3">
      ...
      <div className="text-secondary flex flex-col gap-3 text-base">
        <p>
          I am a Software Development Engineer at HSBC, where I build dependable 
          software systems and tackle interesting technical problems. I enjoy 
          thoughtful engineering, clean design, and exploring new tools and 
          technologies.
        </p>
        <p>
          Check out my{' '}
  ...
  return (
    <motion.div variants={fadeInUp} className="flex flex-col gap-3">
      <div className="grid grid-cols-1 gap-x-6 gap-y-4 min-[380px]:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)] sm:grid-cols-[minmax(12rem,1.5fr)_minmax(6rem,1fr)_minmax(6rem,1fr)]">
        <ContactLink
          href="https://www.linkedin.com/in/kovid-sharma-linkdin/"
          title="Kovid Sharma"
          website="LinkedIn"
        />
        <ContactLink
          href="https://github.com/kovid-sharma"
          title="@kovid-sharma"
          website="GitHub"
        />
        <ContactLink
          email="kovid2020@gmail.com"
          title="kovid2020[at]gmail[dot]com"
          website="Email"
        />
        <ContactLink
          href="/kovid_main.pdf"
